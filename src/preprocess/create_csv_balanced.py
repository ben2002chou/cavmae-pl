...
main_folder_path = '/grand/EVITA/ben/AudioSet/balanced/videos' # /grand/EVITA/ben/Audioset/videos
csv_file_path = '/home/ben2002chou/code/cav-mae/data/video_path_balanced.csv'
